...
module AutoMapperJs {
    ...
    describe('AutoMapper.createMap.forMember', () => {
        ...
        it('should be able to use mapFrom to map from property which is ignored itself on destination and do some more', () => {
            ...
            var mapFromFunc = (opts: IMemberConfigurationOptions) => { opts.mapFrom('prop2'); };
            var ignoreFunc = (opts: IMemberConfigurationOptions) => { opts.ignore(); };
            var ignoreSourceFunc = (opts: ISourceMemberConfigurationOptions) => { opts.ignore(); };
            var constantFunc = () => { return 12; };
            ...
            var destination3 = TestHelper.createDestinationProperty('prop3', 'prop3', 'prop3', null, [{ transformationType: DestinationTransformationType.SourceMemberOptions, sourceMemberConfigurationOptionsFunc: ignoreSourceFunc }], true, true);
        ...
        it('should be able to use forMember to map a couple of nested source properties to a couple of nested destination properties', () => {
            ...
            var mapFromHomeAddressAddress2 = (opts: IMemberConfigurationOptions) => { opts.mapFrom('homeAddress.address2'); },
            ...
            var mapFromBusinessAddressAddress1 = (opts: IMemberConfigurationOptions) => { opts.mapFrom('businessAddress.address1'); },
    ...
    class TestHelper {
        ...
        public static createDestinationProperty(name: string, sourceName: string, destinationName: string, parent: IDestinationProperty, transformations: IDestinationTransformation[], ignore: boolean, sourceMapping: boolean): IDestinationProperty {
            var property = <IDestinationProperty>{
                name: name,
        ...
        public static createSourceProperty(name: string, sourceName: string, destinationName: string, parent: ISourceProperty, destination: IDestinationProperty): ISourceProperty {
