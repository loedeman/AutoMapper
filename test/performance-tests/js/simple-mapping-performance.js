...
(function (AutoMapperJS) {
    'use strict';
    var SimpleMappingPerformance = (function () {
        function SimpleMappingPerformance() {
        }
        SimpleMappingPerformance.prototype.execute = function (repetitions) {
        ...
        SimpleMappingPerformance.prototype.executeMappingDefaults = function (executeRepeatFunc, repetitions) {
            var fromObj = {
                prop1: 'Value1',
                prop2: 'Value2'
            };
        ...
        SimpleMappingPerformance.prototype.executeSimpleMapping = function (executeRepeatFunc, repetitions) {
            var fromObj = {
                prop1: 'Value1',
                prop2: 'Value2'
            };
        ...
        SimpleMappingPerformance.prototype.executeOverruleMapping = function (executeRepeatFunc, repetitions) {
        ...
        SimpleMappingPerformance.prototype.executeMapFromMapping = function (executeRepeatFunc, repetitions) {
            var fromObj = { prop1: 'From A', prop2: 'From A too' };
            var fromKey = '{7AC4134B-ECC1-464B-B144-5B9D8F5B568E}';
            var toKey = '{2BDE907C-1CE6-4CC5-A601-9A94CC665837}';
            var t0 = performance.now();
...
//# sourceMappingURL=simple-mapping-performance.js.map
