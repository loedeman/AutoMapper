...
var AutoMapperJs;!function(r){"use strict";var t=function(){function r(){this.splittingExpression=/(^[a-z]+(?=$|[A-Z]{1}[a-z0-9]+)|[A-Z]?[a-z0-9]+)/,this.separatorCharacter=""}return r.prototype.transformPropertyName=function(r){var t="";console.log(r);for(var a=0,o=r.length;o>a;a++)t+=0===a?r[a].charAt(0).toLowerCase()+r[a].substr(1):r[a].charAt(0).toUpperCase()+r[a].substr(1);return t},r}();r.CamelCaseNamingConvention=t}(AutoMapperJs||(AutoMapperJs={}));
